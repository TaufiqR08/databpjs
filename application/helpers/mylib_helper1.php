...
function tanggal_mysql($tanggal) {
    ...
    function getDataAwalDesa($id)
          {
          $CI =& get_instance();
          $hasil=$CI->db->query("select * from t_pribadi where status_data='0' and id_desa='$id'")->num_rows();
          return $hasil;
          }
    function getDataValidDesa($id)
          {
          $CI =& get_instance();
          $hasil=$CI->db->query("select * from t_pribadi where status_data<>'0' and id_desa='$id'")->num_rows();
          return $hasil;
    ...
    function getLegendValidasi($id)
        {
          $CI =& get_instance();
          $semua=$CI->db->query("select * from t_pribadi where status_data='0' and id_kecamatan='$id'")->num_rows();
