...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'aktivasi@silasidakep.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Silasidakep Dinas Pendudukan dan Pencatatan Sipil'; // Isikan dengan nama pengirim
    protected $password = 'sumedang123'; // Isikan dengan password email pengirim
	//protected $email_pengirim = 'kaisa.ads88@gmail.com'; // Isikan dengan email pengirim
    //protected $password = 'cdouimdxhbzxhidz'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->Host = 'srv80.niagahoster.com';
        ...
        //$mail->AddEmbeddedImage('style/logo_sanggabuana.png', 'Logo', 'logo_sanggabuana.png'); // Aktifkan jika ingin menampilkan gambar dalam email
    ...
    public function send_with_attachment($data){
        ...
        $mail->Subject = $data['subjek'];
        $mail->Body = $data['content'];
        $mail->AddEmbeddedImage('style/logo_sanggabuana.png', 'logo_mynotescode', 'logo_sanggabuana.png'); // Aktifkan jika ingin menampilkan gambar dalam email
