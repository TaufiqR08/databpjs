...
class Login extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('server/login', $this->data);
	}
	...
	public function cek_akses()
	{
		if (!$this->ion_auth->logged_in()){
			...
			$url = 'server/login'; // url untuk redirect
		}else{
	...
	{
		activity_log("auth", "Logout", $this->session->userdata('admin_id'), $this->session->userdata('admin_id_samsat'), 'LEVEL SAMSAT');
		$this->ion_auth->logout();
		redirect('server/login/admin','refresh');
	}
