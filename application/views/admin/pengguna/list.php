<section class="content">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
              <div class="mt-3 mb-4">
            <a href="<?= base_url('admin/pengguna/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
  ...
  <script src="<?= base_url() ?>assets/dist/js/app/master/pengguna/list.js"></script>