        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <?=form_open('admin/samsat/edit_info', array('id'=>'user_info'), array('id'=>$users->id))?>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                    <label>
                        <input <?=$users->aktif==='1'?"checked":""?> type="radio" name="aktif" value="1"> Aktif
                    </label>
                    <label>
                        <input <?=$users->aktif==='0'?"checked":""?> type="radio" name="aktif" value="0"> Tidak Aktif
                    </label>
                    <small class="help-block"></small>
                </div>
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Ganti Foto Samsat</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?=form_open_multipart('admin/samsat/edit_foto', array('id'=>'user_foto'),array('id'=>$users->id))?>
                <div class="card-body">
                <div class="form-group">
                    <div class="form-group col-sm-6">
                ...
                <div class="card-footer">
                <button type="submit" id="btn-foto" class="btn btn-primary">Simpan</button>
                </div>
              </form>
            </div>
