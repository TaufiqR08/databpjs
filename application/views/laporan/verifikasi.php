...
<section class="content">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Verifikasi Data</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="mt-3 mb-4">
              ...
              <?php echo $this->session->flashdata("k");?>
                ...
                <tr>
                    ...
                    <th class="text-center">Data Terverifikasi</th>
                    <th class="text-center">Target Data Desa</th>
  ...
  <script src="<?= base_url() ?>assets/dist/js/app/data/laporan/list.js"></script>