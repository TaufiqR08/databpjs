                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mt-3 mb-4">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<?=base_url('server/admin/add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                        </div>
...
<script src="<?= base_url() ?>assets/dist/js/app/data/admin/list.js"></script>