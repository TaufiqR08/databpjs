...
<section class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card card-danger">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?=form_open_multipart('server/admin/save', array('id'=>'user_info'))?>
                                    <div class="card-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <p style="color:red;font-weight: italic">* Jika user sebagai admin tidak perlu memilih Kecamatan</p>
                                            </div>
                                            <div class="form-group col-sm-6">
  ...
  <script src="<?= base_url() ?>assets/dist/js/app/data/admin/add.js"></script>