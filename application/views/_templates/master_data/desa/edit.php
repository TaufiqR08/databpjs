...
<section class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card card-danger">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?=form_open_multipart('server/desa/update', array('id'=>'user_info'))?>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                <label for="first_name">Nama Desa</label>
                                                <input type="hidden" value="<?=$ddesa['id_desa'];?>" name="id_desa">
                                                <input type="text" name="nama_desa" value="<?=$ddesa['nama_desa']; ?>" class="form-control" required>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <select id="kecamatan" name="kecamatan" class="form-control select2" style="width: 100%!important">
                                                    <option value="<?=$ddesa['id_kecamatan'];?>"><?=$ddesa['nama_kecamatan'];?></option>
  ...
  <script src="<?= base_url() ?>assets/dist/js/app/data/desa/edit.js"></script>