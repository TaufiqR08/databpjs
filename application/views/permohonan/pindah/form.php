...
<section class="wrapper" style="color:black;">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Form Pengajuan Layanan Surat Keterangan Pindah
                    </div>
            ...
            Pemohon hanya mengisi isian yang tersedia pada form. Untuk file yang diupload silahkan gunakan file JPEG,PNG dan BMP dengan besar file maks (3 Mb). Setelah semua diisi klik tombol proses.Sementara Hanya Melayani Pengiriman Lewat POS. Untuk Formulir Pendaftaran silahkan di download di link yang sudah disediakan. Kemudian di cetak masing-masing. Apabila sudah dicetak silahkan scan/foto menggunakan Kamera HP Kemudian Upload.Apabila Mengalami Kesulitan Silahkan meminta bantuan operator di Desa. 
                        ...
                        <form action="<?php echo base_url(); ?>permohonan/pindah/act_add" method="post" enctype="multipart/form-data">
...
<div class="row">
        ...
        <?php
          $l_sifat  = array('Permohonan Pindah Antar Kab/Kota/Provinsi','Permohonan Pindah Datang Kab/Kota/Provinsi');
        ...
        <?php
          $l_sifat  = array('Pekerjaan','Pendidikan','Keamanan','Kesehatan','Perumahan','Keluarga');
        ...
        ?>
                ...
                <div class="col-12 col-md-6 col-lg-4">
				    <div class="form-group">
                        <label for="file">Upload Scan Formulir (<a href="<?php echo base_url(); ?>dokumen/form_pindah_wni.pdf">Download Formulir</a>)</label>
					...
					<div class="form-group">
                        <label for="file">Upload Scan KTP Elektronik</label>
                ...
                <div class="col-12 col-md-6 col-lg-4">
				    <div class="form-group">
                        <label for="file">Upload Scan Formulir (<a href="<?php echo base_url(); ?>dokumen/form_pindah_datang_wni.pdf">Download Formulir</a>)</label>
                        <input type="file" class="form-control" id="gambar4" name="gambar[]" required>
                    </div>
					<div class="form-group">
                        <label for="file">Upload Scan SKPWNI</label>
