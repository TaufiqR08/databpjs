...
<head>
  ...
  <title>Aplikasi Data Warga Kabupaten Sumbawa Barat</title>
...
<body class="hold-transition login-page" style="background-color: #fff00;background-repeat: repeat;background-attachment: fixed;background-position: center;background-size: cover;">
<div>
<h5 class="text-center" style="letter-spacing: 1.5px;">SISTEM VERIFIKASI DATA WARGA<br> 
BAPPEDA & LITBANG KAB. SUMBAWA BARAT
</div>
</h5>
<div class="login-box">
<div class="login-logo">
  ...
  <div class="card">
	...
	<?= form_open("server/auth/cek_login", array('id'=>'login'));?>
