<section class="content">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?=form_open('server/operator/pengguna/edit_info', array('id'=>'user_info'), array('id'=>$users->id))?>
                <div class="card-body">
              ...
              <?=form_open('admin/pengguna/edit_samsat', array('id'=>'user_level'), array('id'=>$users->id))?>
                ...
                <div class="form-group">
                    ...
                    <select id="level" name="samsat" class="form-control select2" style="width: 100%!important">
                            <option <?=$users->id_samsat===$samsat->id ? "selected" : ""?> value="<?=$samsat->id?>"><?=$samsat->nama?></option>
  ...
  <script src="<?=base_url()?>assets/dist/js/app/operator/pengguna/edit.js"></script>
