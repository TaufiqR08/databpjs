            ...
            <div class="card card-danger">
              ...
              <?php if ($this->session->flashdata('success')): ?>
                  <script>
                      ...
                      window.location.href = "<?php echo base_url(); ?>server/warga/kk/<?php echo $this->uri->segment(4); ?>";
                      });
                  </script>
              <?php endif; ?>
              ...
              <?=form_open_multipart('server/warga/save_anggota')?>
                <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="first_name">NIK</label>
                         <input type="hidden" name="id_user" value="<?php echo $this->session->userdata('admin_id'); ?>">
                        <input type="text" name="nik" onkeyup="niksama();" class="form-control" maxlength="16" minlength="16" onkeypress="return Angkasaja(event)" required>
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="last_name">Nama Lengkap</label>
                        <input type="text" name="nama_lengkap" class="form-control" onkeyup="namasama();" required>
                        <small class="help-block"></small>
                    </div>
                </div>
                <div class="row">
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="nokk" class="form-control" value="<?= getno_kk($this->uri->segment(4));?>" maxlength="16" minlength="16" onkeypress="return Angkasaja(event)" required readonly >
                    <small class="help-block"></small>
                </div>
                  </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="nik_kepala" class="form-control" value="<?= $this->uri->segment(4);?>" required readonly> 
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="last_name">Nama Kepala Keluarga</label>
                        <input type="text" name="nama_kepala" class="form-control" value="<?= getKepala1($this->uri->segment(4));?>" required readonly>
                        <small class="help-block"></small>
                    </div>
                </div>
