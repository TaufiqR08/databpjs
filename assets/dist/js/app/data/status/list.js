...
$(document).ready(function() {
  ...
  table = $("#data").DataTable({
    ...
    oLanguage: {
      sProcessing: "loading...",
      sSearch: "Cari Dengan Nama Status"
    },
    processing: true,
    serverSide: true,
    responsive:true,
    autoWidth: false,
    ajax: {
      url: base_url + "server/status/data",
      type: "POST"
    },
    columns: [
      {
    ...
    columnDefs: [
      {
          ...
          render: function(data, type, row, meta) {
                  return `<div class="text-center">
                          <a class="btn btn-success" href="${base_url}server/status/edit/${data}">
...
function hapus(id) {
  Swal({
      ...
      if (result.value) {
          $.getJSON(base_url + "server/status/delete/" + id, function(data) {
              Swal({
