...
$(document).ready(function() {
  ...
  table = $("#data").DataTable({
    ...
    autoWidth: false,
    ajax: {
      url: base_url + "server/kecamatan/data",
      type: "POST"
    },
    columns: [
      {
    ...
    columnDefs: [
      {
          ...
          render: function(data, type, row, meta) {
                  return `<div class="text-center">
                          <a class="btn btn-success" href="${base_url}server/kecamatan/edit/${data}">
...
function hapus(id) {
  Swal({
      ...
      if (result.value) {
          $.getJSON(base_url + "server/kecamatan/delete/" + id, function(data) {
              Swal({
