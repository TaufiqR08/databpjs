    ...
    columnDefs: [
      {
          ...
          render: function(data, type, row, meta) {
                  return `<div class="text-center">
                          <a class="btn btn-success" href="${base_url}server/menu/edit/${data}">
...
function hapus(id) {
  Swal({
      ...
      if (result.value) {
          $.getJSON(base_url + "server/menu/delete/" + id, function(data) {
              Swal({
